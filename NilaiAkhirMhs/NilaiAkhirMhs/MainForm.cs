...
namespace NilaiAkhirMhs
{
	...
	public partial class MainForm : Form
	{
		...
		public void UpdateData(){
			try{
				mycommand.Connection=conn;
				mycommand.CommandText = "update data_mahasiswa set NAMA='"+NAMA.Text+"',KELAS='"+KELAS.Text+"',ABSENSI='"+ABSENSI.Text+"',TUGAS='"+TUGAS.Text+"',UTS='"+UTS.Text+"',UAS='"+UAS.Text+"',HASIL='"+HASIL.Text+"',GRADE='"+GRADE.Text+"',KETERANGAN='"+KETERANGAN.Text+"'where NIM ='"+NIM.Text+"' ";
				myadapter.SelectCommand = mycommand;
				if (mycommand.ExecuteNonQuery()==1){
