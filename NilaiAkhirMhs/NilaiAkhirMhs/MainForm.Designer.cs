...
namespace NilaiAkhirMhs
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// KETERANGAN
			// 
			this.KETERANGAN.BackColor = System.Drawing.Color.Moccasin;
			...
			// HASIL
			// 
			this.HASIL.BackColor = System.Drawing.Color.Yellow;
			...
			// GRADE
			// 
			this.GRADE.BackColor = System.Drawing.Color.Aqua;
			...
			// BtnHitung
			// 
			this.BtnHitung.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
			...
			this.label10.Size = new System.Drawing.Size(748, 75);
			this.label10.TabIndex = 26;
			this.label10.Text = "NILAI AKHIR MAHASISWA";
			// 
			// label11
			// 
			...
			this.groupBox1.Text = "Identitas Mahasiswa";
			// 
			// groupBox2
			// 
			...
			this.groupBox2.Text = "Nilai Mahasiswa";
			// 
			// groupBox3
			// 
			...
			this.groupBox3.Text = "Hasil Akhir Mahasiswa";
			// 
			// pencarian
			// 
			...
			this.pencarian.Text = "Pencarian Data Nilai Akhir Semester Mahasiswa";
			// 
			// kotakcari
			// 
			...
			this.Text = "Aplikasi Nilai Akhir Mahasiswa";
